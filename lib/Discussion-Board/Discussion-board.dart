...
import 'package:css_app/Discussion-Board/threadMain.dart';
import 'package:css_app/Discussion-Board/userProfile.dart';
...
class Discussionboard extends StatefulWidget {
  const Discussionboard({Key key}) : super(key: key);
